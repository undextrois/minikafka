...
Tests
 echo '{"action":"create_topic","topic":"my_test_topic"}' | nc localhost 9092
 echo '{"action":"produce","topic":"my_test_topic","value":"hello"}' | nc localhost 9092
 echo '{"action":"consume","topic":"my_test_topic"}' | nc localhost 9092
